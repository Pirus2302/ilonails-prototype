...
Прототип: https://pirus2302.github.io/ilonails-prototype/ (главная: / с переключателем блока проблем `?problems=map|ask|tiles`, старый вариант A: /index-a.html, страница проблемы: /vrosshiy-nogot.html)
