...
Страницы: `index.html` (главная), `vrosshiy-nogot.html` (шаблон страницы проблемы), `ceny.html`, `o-tsentre.html`, `specialisty.html`, `ilona.html`, `kursy.html`, `blog.html` + `statya.html` (шаблон статьи), `kontakty.html`. Осталось семь страниц проблем 3–9 по ТЗ.
